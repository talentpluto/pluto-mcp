...
compatible with server contract `4.10.0` through server contract `4.16.0`
...
category hint to web-presence findings; and 4.16.0 adds rubric editing — none
of which changes this route's own tools). On any conflict, prefer the live tool
